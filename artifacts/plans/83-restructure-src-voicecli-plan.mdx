...
- T1: 14 — adapters (Move src/voicecli/nats/ → src/voicecli/adapters/nats/)
- T2: 15 — api (Create src/voicecli/api/ — 7 modules + re-exports)
- T3: 16 — engines (Promote engine.py into engines/engine.py)
- T4: 17 — runtime (Create runtime/ + rename daemon_protocol → wire_protocol)
- T5: 18 — ui (Create ui/ — 8 files)
- T6: 19 — core (Create core/ — 8 files, highest fan-in)
- T7: 20 — cli (Create cli/ — 5 files + __init__.py re-export)
- T8: 21 — tooling (.importlinter rewrite + exemption removal + axial allowlist + CHANGELOG + follow-up issue)
- T9: 22 — accept (Final acceptance verification — all 19 SC)
